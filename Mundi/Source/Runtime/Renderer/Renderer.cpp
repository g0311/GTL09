...
void URenderer::RenderSceneForView(UWorld* World, UCameraComponent* CameraComponent, FViewport* Viewport)
{
	if (!CameraComponent)
	{
		UE_LOG("[URenderer::RenderSceneForView]: CameraComponent is nullptr");
		return;
	}
